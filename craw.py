...
class AppCrawler:
	...
	def get_app_from_link(self,link):
		...
		app = App(name,developer,price,links) #App() new instant
...
crawler = AppCrawler("https://itunes.apple.com/in/app/candy-crush-saga/id553834731?mt=8",1)		
crawler.crawl()

for app in crawler.apps: #crawler.apps = self.apps in AppCrawler class
	print app
